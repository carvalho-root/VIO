...
## 🚀 O Projeto VIO
O VIO vai além de um simples reprodutor de áudio; é um ecossistema imersivo de gestão musical que utiliza inteligência de dados para personalizar a experiência do usuário.
